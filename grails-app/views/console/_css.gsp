...
<link rel="stylesheet" media="screen" href="${resource(file: '/vendor/jquery-ui-1.10.3/jquery-ui.min.css')}" />
<link rel="stylesheet" media="screen" href="${resource(file: '/dist/release/app.css')}" />